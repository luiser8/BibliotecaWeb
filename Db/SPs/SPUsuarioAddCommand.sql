...
CREATE PROCEDURE [dbo].[SPUsuarioAddCommand]
...
BEGIN
    ...
    BEGIN TRY
        INSERT INTO dbo.Usuarios(ExtensionId, RolId, Correo, Contrasena)
        VALUES(@ExtensionId, @RolId, @Correo, @Contrasena);
    ...
    BEGIN CATCH
        ...
        BEGIN
            SELECT 
                -1 AS Id,
                'El correo electrónico ya está registrado en el sistema' AS ErrorMessage,
