...
CREATE TABLE UsuariosRecuperacion
(
	Id INT NOT NULL PRIMARY KEY IDENTITY(1,1), 
	...
	Activo TINYINT NOT NULL DEFAULT 1,
	FechaCreado DATETIME NOT NULL DEFAULT GETDATE(),
	CONSTRAINT FK_USUARIO_RECUPERACION_ID FOREIGN KEY (UsuarioId) REFERENCES Usuarios (Id) ON DELETE CASCADE ON UPDATE NO ACTION
);
...
(
	Id INT NOT NULL PRIMARY KEY IDENTITY(1,1),
    Nombre VARCHAR(255) NULL, -- Matematicas, Fisica, Informatica, etc
	Activo TINYINT NOT NULL DEFAULT 1,
	FechaCreado DATETIME NOT NULL DEFAULT GETDATE()
);
...
(
	...
	CONSTRAINT FK_AREA_ID FOREIGN KEY (AreaId) REFERENCES Areas (Id) ON DELETE CASCADE ON UPDATE NO ACTION
);
